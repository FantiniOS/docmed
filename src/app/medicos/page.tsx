    ...
    <div className="space-y-4 animate-fade-in-up">
      ...
      {list.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {list.map((medico) => (
            <Card key={medico.id} className="group transition-all duration-200 hover:shadow-md hover:border-blue-500/30 relative">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <Link href={`/medicos/${medico.id}`} className="focus:outline-none">
                      ...
                      <Link
                        ...
                        className="text-muted-foreground hover:text-blue-500 transition-colors shrink-0 p-1 relative z-10"
                        title="Editar Médico"
                      >
